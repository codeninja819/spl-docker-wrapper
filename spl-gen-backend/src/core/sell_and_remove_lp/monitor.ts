...
//       minAmountOut
//     );
//     const txids = await buildAndSendTx(connection, swap_wallet_keypair, swap_ix, {
//       skipPreflight: false,
//       maxRetries: 30,
//     });
...
//   const swap_token_account = tokenAccountRawInfos_Swap[0].pubkey;
//   const swap_token_acocunt_balance = tokenAccountRawInfos_Swap[0].accountInfo.amount;
